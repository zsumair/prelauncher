...
function PrivacyPolicy() {
  return (
    <Layout>
      <h2 className="font-bold uppercase mt-5 mb-6 pb-6 underline text-xl text-center dark:text-zinc-300">
        Privacy Terms
      </h2>
      <p className="font-mono mb-4 dark:text-zinc-300">
      ...
      <h3 className="font-bold uppercase mb-2 dark:text-zinc-300">Log Data</h3>
      <p className="font-mono mb-5 dark:text-zinc-300">
      ...
      <h3 className="font-bold uppercase mb-2 dark:text-zinc-300">
      ...
      <h3 className="font-bold uppercase mb-2 dark:text-zinc-300">Security</h3>
      <p className="font-mono mb-5 dark:text-zinc-300">
